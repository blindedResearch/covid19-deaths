...
stateGovernor = rbind(stateGovernor,
                      c('DISTRICT OF COLUMBIA', 'Democratic')) # since DC Mayor is a Democrat (DC is not a state)
...
### Resulting Model
```{r multiModel2, results='asis', dependson = "multinom"}
...
### Model's Performance
```{r predictivePerformance, dependson = "multinom"}
...
```{r clusterMatch, dependson = "multinom"}
...
```{r multiModelInference, dependson = "multinom"}
